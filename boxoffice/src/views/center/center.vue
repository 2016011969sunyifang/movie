        ...
        <div class="avatar">
          ...
          <img
            ...
            :src="
              icon
                ? icon
                : 'data:image/png;base64,'
            "
          />

          <div v-if="flag" class="nick-name" @click="login()">
            {{ this.flag.data.mobile }}
          </div>
...
export default {
  ...
  //页面渲染之后
  mounted() {
    this.flag = this.$store.state.usermobile;
    this.icon = this.$store.state.usermobile.data.icon;
...
.center-view {
  ...
  font-size: 15px;
  background: #f4f4f4;
  // border-bottom: 99px solid #f4f4f4;
}
